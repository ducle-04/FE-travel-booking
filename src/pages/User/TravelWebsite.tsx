...
import { MapPin, Plane, Hotel, Users, Navigation, ChevronDown } from 'lucide-react';
    ...
    return (
        <div className="w-full">
            ...
            >
                ...
                {/* Content */}
                <div className="relative z-10 text-center px-4 max-w-3xl drop-shadow-lg">
                    <div className="flex justify-center mb-6">
                        <MapPin className="w-16 h-16 text-cyan-500 drop-shadow-md" aria-hidden="true" />
                    </div>
                    ...
                    <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-gray-800">
                        Chúng tôi là công ty du lịch chuyên tổ chức các tour trong và ngoài nước,
                        mang đến trải nghiệm chân thật và đáng nhớ cho khách hàng.
                    </p>
            ...
            <section className="py-20 bg-gray-50 px-4">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-16 text-gray-900">🗺️ Tầm nhìn - Sứ mệnh - Giá trị cốt lõi</h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-bold text-blue-600 mb-4">Tầm nhìn</h3>
                            <p className="text-gray-700">Trở thành nền tảng đặt tour hàng đầu Việt Nam, kết nối hàng triệu du khách với những trải nghiệm tuyệt vời.</p>
                        </div>
                        <div className="bg-white p-8 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-bold text-blue-600 mb-4">Sứ mệnh</h3>
                            <p className="text-gray-700">Giúp mọi người du lịch dễ dàng, an toàn và tiết kiệm, biến mỗi chuyến đi thành một ký ức vô tận.</p>
                        </div>
                        <div className="bg-white p-8 rounded-lg shadow-lg">
                            <h3 className="text-2xl font-bold text-blue-600 mb-4">Giá trị cốt lõi</h3>
                            <p className="text-gray-700">Trung thực • Chuyên nghiệp • Tận tâm • Sáng tạo • Tiên phong</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="services" className="py-20 bg-white px-4">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-16 text-gray-900">🏖️ Dịch vụ chính của chúng tôi</h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        {([
                            {
                                icon: MapPin,
                        ...
                        ] as Service[]).map((service, idx) => {
                            const Icon = service.icon;
                            return (
                                <div
                                    key={idx}
                                    className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg shadow-md hover:shadow-xl transition transform hover:scale-105"
                                >
            ...
            {/* Team */}
            <section id="team" className="py-20 bg-gray-50 px-4">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-4 text-gray-900">👥 Đội ngũ tuyệt vời của chúng tôi</h2>
                    <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">"Niềm vui của khách hàng là thành công của chúng tôi"</p>
                    <div className="grid md:grid-cols-4 gap-6">
                        {[
                            { name: "Nguyễn Văn A", role: "Hướng Dẫn Viên", exp: "15 năm kinh nghiệm" },
                            { name: "Trần Thị B", role: "Tư Vấn Du Lịch", exp: "10 năm kinh nghiệm" },
                            { name: "Lê Văn C", role: "Hướng Dẫn Viên", exp: "12 năm kinh nghiệm" },
                            { name: "Phạm Thị D", role: "Quản Lý Tour", exp: "8 năm kinh nghiệm" },
                        ].map((member, idx) => (
            ...
            {/* Achievements */}
            <section id="achievements" className="py-20 bg-white px-4">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-16 text-gray-900">📸 Thành tựu & Đối tác</h2>
                    ...
                    <div className="mb-8">
                        <h3 className="text-2xl font-bold text-center mb-8 text-gray-900">Đối Tác Tin Tưởng</h3>
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 items-center justify-items-center">
                            {["Vietnam Airlines", "Agoda", "Booking.com", "Expedia", "TripAdvisor"].map((partner, idx) => (
                                <div key={idx} className="bg-gray-100 px-4 py-3 rounded-lg text-center font-semibold text-gray-700 w-full">
                                    {partner}
                                </div>
                            ))}
                        </div>
            ...
            <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white px-4">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-12">🏆 Giấy phép & Cam kết chất lượng</h2>
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-blue-500 bg-opacity-50 p-8 rounded-lg">
                            ...
                            <p className="text-lg">Giấy phép kinh doanh du lịch: <strong>0123456789</strong></p>
                            <p className="text-lg mt-2">Mã số doanh nghiệp: <strong>0123456789</strong></p>
                        </div>
                        <div className="bg-blue-500 bg-opacity-50 p-8 rounded-lg">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={idx} className="h-64 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition">
                                <img
                                    src={img}
