                    ...
                    <div className="footer-animate-item opacity-0 translate-y-10 scale-95 transition-all duration-[600ms] ease-[cubic-bezier(0.4,2,0.6,1)] [&.footer-item-visible]:opacity-100 [&.footer-item-visible]:translate-y-0 [&.footer-item-visible]:scale-100">
                        ...
                        <div className="space-y-2 text-gray-400 text-sm">
                            <div className="flex items-center">
                                <Phone size={16} className="mr-3 text-cyan-400" aria-hidden="true" />
                                <span>0123 456 789</span>
                            </div>
                            <div className="flex items-center">
                                <Mail size={16} className="mr-3 text-cyan-400" aria-hidden="true" />
                                <span>info@wondertrail.com</span>
                            </div>
                            <div className="flex items-center">
                                <MapPin size={16} className="mr-3 text-cyan-400" aria-hidden="true" />
                    ...
                    <div className="footer-animate-item opacity-0 translate-y-10 scale-95 transition-all duration-[600ms] ease-[cubic-bezier(0.4,2,0.6,1)] [&.footer-item-visible]:opacity-100 [&.footer-item-visible]:translate-y-0 [&.footer-item-visible]:scale-100">
                        ...
                        <div className="h-40 rounded-lg overflow-hidden shadow-lg">
                            <iframe
                                ...
                                allowFullScreen
                                loading="lazy"
                                title="Bản đồ địa chỉ WonderTrail tại Hà Nội"
                                aria-label="Bản đồ hiển thị địa chỉ 123 Đường Du Lịch, Hà Nội"
                            ></iframe>
                        </div>
                    </div>
                </div>
